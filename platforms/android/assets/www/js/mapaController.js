      ...
      google.maps.event.addListenerOnce($scope.map, 'idle', function(){
        ...
        responseRecuperaPostos1.success(function(data, status, headers, config) {
          ...
          for(var counter = 0;counter < data.length-1;counter++){ // sempre ignorar ultima posicao do array
            $scope.criarMarkers(data[counter].coordenadaY, data[counter].coordenadaX);
          }
        ...
        /*var responseRecuperaPostos2 = $http.get('http://ec2-52-67-37-24.sa-east-1.compute.amazonaws.com:8080/scgas/rest/postoservice/listaPostos/0/45/'+position.coords.latitude+'/'+position.coords.longitude, {timeout: 5000});
        ...
        var responseRecuperaPostos3 = $http.get('http://ec2-52-67-37-24.sa-east-1.compute.amazonaws.com:8080/scgas/rest/postoservice/listaPostos/0/45/'+position.coords.latitude+'/'+position.coords.longitude, {timeout: 5000});
